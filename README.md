...
- US9-style CSV upload and interactive Map Studio for multi-site scans
...
- Public basemap with zoom/pan, click-to-inspect site details, and PNG/SVG plot export
...
The Help tab includes a built-in Ask Guide that answers common workflow, interpretation, CSV, array, study, and report questions directly in the browser.
